  ...
  return (
   ...
   <div className='absolute w-[80%] h-[80%] bg-black z-10 backdrop-blur-[6px] bg-black/10 rounded-2xl flex '>
       <div className='w-[50%] h-full flex flex-col justify-center items-start p-16'>
           <p className='text-6xl font-semibold '>Let's Get Started</p>
       ...
       <div className='w-[50%] h-full flex  justify-center items-center bg-black/80 rounded-tr-2xl rounded-br-2xl  p-20'>
                ...
                >
                  {({ errors, touched }) => (
                      ...
                      <p className='text-5xl p-5'>Sign Up</p>
                      ...
                      <div className="flex flex-col justify-center items-start p-5">
                        ...
                        <p className='w-full flex justify-center items-center'>
                          Already have an account? <a href="/login" className='pl-2'>Login</a>
                        </p>

                        <div className="w-full flex justify-center items-center">
                        <button type="submit" className="bg-transparent border-2 border-white text-white py-2 px-16 mt-8 rounded-md hover:bg-white hover:text-black focus:outline-none transition-all duration-300">Sign up</button>
                        </div>
                      </div>
                    </Form>
                  )}
              ...
              <div className="h-full w-52 flex flex-col justify-center items-center">
